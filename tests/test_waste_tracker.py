...
def test_compute_waste(mock_load):
    ...
    mock_load.return_value = [
        ...
        {"key": "antigravity:prof::m1", "ts": "t1", "_ts": 1, "pct_left": 30, "tool": "antigravity"},
        {"key": "antigravity:prof::m1", "ts": "t2", "_ts": 2, "pct_left": 100, "tool": "antigravity"},
        
        # Antigravity reset below threshold (ignored)
        {"key": "antigravity:prof::m2", "ts": "t1", "_ts": 1, "pct_left": 15, "tool": "antigravity"},
        {"key": "antigravity:prof::m2", "ts": "t2", "_ts": 2, "pct_left": 100, "tool": "antigravity"},
    ]
